...
class WeatherScreen extends StatelessWidget {
  ...
  WeatherType weatherIdToType(final int id) {
    if (id>=200 && id<=232) { // Tunderstorm
      ...
      if (id<=501) return WeatherType.lightRainy;
      else if (id<=511) return WeatherType.middleRainy;
      else return WeatherType.heavyRainy;
    } else if (id>=600 && id<=622) { // Snow
      if (id<=601) return WeatherType.lightSnow;
      else if (id<=612) return WeatherType.middleSnow;
      else return WeatherType.heavySnow;
    } else if (id>=701 && id<=781) { // Athmosfere
      if (id<=721) return WeatherType.hazy;
      else if (id==741) return WeatherType.foggy;
      else return WeatherType.dusty;
      ...
      body: Center(
        child: Column(
          children: [
            ...
            WeatherBg(weatherType: WeatherType.middleRainy, height: 200, width: 200,)
          ],
        ),
      ),
    );
